...
;(function (App) {
  ...
  var SEED_USERS = [
    ...
    },
    {
      ...
      role: 'student',
      class: 'CS-2025-A',
      mission: 'Building Responsive UI for Capstone',
    ...
    },
    {
      ...
      role: 'student',
      class: 'CS-2025-A',
      mission: 'AI for Healthcare in Sub-Saharan Africa',
      bio: 'CS student focused on machine learning applications',
      createdAt: '2025-09-01T00:00:00.000Z',
      updatedAt: '2025-09-01T00:00:00.000Z'
    },
    {
      ...
      role: 'student',
      class: 'BUS-2025-A',
      mission: 'Social Enterprise for Youth Employment in East Africa',
      bio: 'Business student with a focus on social entrepreneurship',
      createdAt: '2025-09-01T00:00:00.000Z',
      updatedAt: '2025-09-01T00:00:00.000Z'
    },
    {
      ...
      role: 'student',
      class: 'ENV-2025-A',
      mission: 'Sustainable AgriTech Solutions for Rural Communities',
      bio: 'Environmental science student researching precision agriculture',
      createdAt: '2025-09-01T00:00:00.000Z',
      updatedAt: '2025-09-01T00:00:00.000Z'
    },
    {
      ...
      role: 'student',
      class: 'BUS-2025-A',
      mission: 'FinTech Solutions for Unbanked Communities',
      bio: 'Business student passionate about financial inclusion',
      createdAt: '2025-09-01T00:00:00.000Z',
      updatedAt: '2025-09-01T00:00:00.000Z'
    },
    {
      ...
      role: 'student',
      class: 'CS-2025-B',
      mission: 'NLP Tools for African Language Preservation',
      bio: 'CS student working on low-resource language processing',
      createdAt: '2025-09-01T00:00:00.000Z',
      updatedAt: '2025-09-01T00:00:00.000Z'
    }
  ];
  ...
  var SEED_RECORDS = [
    ...
    },
    {
      ...
      notes: 'Dense but essential for my ML capstone.',
      recommended: true,
      coverColor: '#0D1A6B',
      approved: true,
      approvedBy: 'u_fac_001',
    ...
    },
    {
      ...
      tag: 'Social Impact',
      dateAdded: '2025-09-20',
      notes: 'Core reference for my youth employment venture.',
      recommended: true,
      coverColor: '#0A4A2A',
      approved: true,
      approvedBy: 'u_fac_001',
    ...
    },
    {
      ...
      notes: 'Framework for sustainable boundaries — fits AgriTech mission.',
      recommended: false,
      coverColor: '#1A4A0A',
      approved: true,
      approvedBy: 'u_fac_001',
